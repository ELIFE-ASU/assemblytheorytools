...
def test_bug_08222025():
    ...
    # Need to write functionality into construction.parse_pathway_file to read in edge list, then compare with original object to back out the original edge colorings because they get lost in assemblycpp
    assert path
