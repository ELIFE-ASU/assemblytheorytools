...
2.  **Parallel Computation**: Efficiently convert raw SMILES strings to molecule objects and calculate their Assembly Indices using parallel processing tools (`att.mp_calc`, `att.calculate_assembly_index_parallel`) to handle computational load.
3.  **Visualization**:
